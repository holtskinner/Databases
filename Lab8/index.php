        ...
        <div class="container">
            ...
            <?php
                ...
                { // Was the form submitted?
					...
					$sql = "INSERT INTO user(username,salt,hashed_password,isadmin) VALUES (?,?,?,?)";
					if ($stmt = mysqli_prepare($link, $sql)) 
                    {
                        ...
                        if($user == "adminUser" && $_POST['password'] == "admin")
                        {
                           $admin =1;
						  mysqli_stmt_bind_param($stmt, "sssi", $user, $salt, $hpass, $admin) or die("bind param");
